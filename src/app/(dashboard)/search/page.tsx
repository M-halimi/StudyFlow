...
export default async function SearchPage({ searchParams }: SearchPageProps) {
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[var(--muted)]">Search across your subjects, categories, and topics</p>
            </div>
          ...
          <EmptyState
            ...
            description="Enter a query to search across subjects, categories, and topics"
          />
        </div>
      </PageTransition>
    )
  ...
  const totalResults = subjects.length + categories.length + topics.length
