...
import { SessionCardActions } from "@/features/sessions/components/session-card-actions"
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[var(--muted)]">Set your own study duration and focus</p>
          </div>
